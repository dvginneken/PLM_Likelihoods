...
if mode == "general":
    ...
    save_path = os.path.join(repertoire_file_folder,"IMGT_germline_embeddings")
    ...
    for i,model in enumerate(init_list): ### the class method "fit_transform" calculates the embedding of each sequence
        ...
        embeds.to_csv(os.path.join(save_path,dataset,f"embeddings_{suffixes[i]}.csv"), index=False)   
